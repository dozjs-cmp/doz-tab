...
function register() {
    if (typeof window !== 'undefined') {
        ...
        if (_doz.defineWebComponent) {
            ...
            (0, _doz.defineWebComponent)('dwc-doz-tab', _tab2.default, tabProps, tabExposedMethods);
...
var _class = function (_Component) {
    ...
    _createClass(_class, [{
        ...
        value: function template(h) {
            ...
            return h(_templateObject, this.props.buttonsPosition === 'top' ? 'column-reverse' : 'column', this.props.bodyBackgroundColor, this.props.buttonsWrap ? 'wrap' : 'nowrap', this.props.buttonsSize === 'large' ? '16px' : '8px', this.props.buttonColor, this.props.buttonBackgroundColor, this.props.buttonSize === 'large' ? '14px' : '12px', this.props.buttonHoverColor, this.props.buttonHoverBackgroundColor, this.props.buttonSelectedColor, this.props.buttonSelectedBackgroundColor, this.props.items.map(function (item, i) {
